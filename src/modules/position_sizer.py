...
└─ Reward/Risk Ratio: {self.reward_to_risk:.2f}:1
"""
...
class PositionSizer:
    ...
    def size_position(self, position_input: PositionInput) -> PositionOutput:
        ...
        # Base risk * environment multiplier * edge multiplier
        effective_size = (
            self.default_risk_percent * 
            (environment_sizing / 0.05) *  # Normalize to 5% default
            edge_multiplier
        )
        ...
        # 7. Calculate actual position size in dollars
